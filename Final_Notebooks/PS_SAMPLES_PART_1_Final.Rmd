...
|--------------|--------------------------------------------|--------------|
| S4A       | UMAP for full ST dataset (after anchor batch correction)             | [link](#s4a) |
| S4C       | Spatial Dim Plot - NON-LESIONAL SKIN SAMPLE and LESIONAL SKIN SAMPLE | [link](#s4c) |
| S6        |                                                                      | [link](#s6)  |
...
Only for Batch 1 + 2 Samples (LES.A1, NON_LES.A1, LES.B1, NON_LES.B1), Spots were removed via Barcodes
